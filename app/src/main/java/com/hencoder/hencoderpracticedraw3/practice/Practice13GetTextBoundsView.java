...
public class Practice13GetTextBoundsView extends View {
...

    {
        ...
        yOffset[0] = (textBound.top + textBound.bottom) / 2 - middle;

        paint2.getTextBounds(text2, 0, text2.length(), textBound);
        yOffset[1] = (textBound.top + textBound.bottom) / 2 - middle;

        paint2.getTextBounds(text3, 0, text3.length(), textBound);
        yOffset[2] = (textBound.top + textBound.bottom) / 2 - middle;

        paint2.getTextBounds(text4, 0, text4.length(), textBound);
        yOffset[3] = (textBound.top + textBound.bottom) / 2 - middle;

        paint2.getTextBounds(text5, 0, text5.length(), textBound);
        yOffset[4] = (textBound.top + textBound.bottom) / 2 - middle;

        paint2.getTextBounds(text6, 0, text6.length(), textBound);
        yOffset[5] = (textBound.top + textBound.bottom) / 2 - middle;
